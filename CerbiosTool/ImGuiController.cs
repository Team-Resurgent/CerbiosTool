...
namespace RepackinatorUI
{
    public class ImGuiController : IDisposable
    {
        ...
        private IntPtr _cerbiosTextTexture;
        private IntPtr _safeModeTextTexture;
        ...
        public IntPtr CerbiosTextTexture => _cerbiosTextTexture;
        public IntPtr SafeModeTextTexture => _safeModeTextTexture;
        ...
        {
            var fontData = ResourceLoader.GetEmbeddedResourceBytes("CerbiosTool.Resources.ARIALUNI.TTF", typeof(ImGuiController).GetTypeInfo().Assembly);
        ...
        private unsafe IntPtr CreateTextureFromResource(string resourceName)
        {
            ...
            var texture = _gd.ResourceFactory.CreateTexture(TextureDescription.Texture2D((uint)resourceImage.Width, (uint)resourceImage.Height, 1, 1, PixelFormat.R8_G8_B8_A8_UNorm, TextureUsage.Sampled));
            ...
            {
                _gd.UpdateTexture(texture, (IntPtr)pin, (uint)(4 * resourceImage.Width * resourceImage.Height), 0, 0, 0, (uint)resourceImage.Width, (uint)resourceImage.Height, 1, 0, 0);
            }
                        
            var result = GetOrCreateImGuiBinding(_gd.ResourceFactory, texture);
