...
namespace CerbiosTool
{
    public class ImGuiController : IDisposable
    {
        ...
        private int _cerbiosTextTexture;
        private int _safeModeTextTexture;
        private int _logo1Texture;
        ...
        public int Logo1Texture => _logo1Texture;
        ...
        public void CreateDeviceResources()
        {
            ...
            string VertexSource = ResourceLoader.GetEmbeddedResourceString("CerbiosTool.Resources.imgui-vertex.glsl");
            string FragmentSource = ResourceLoader.GetEmbeddedResourceString("CerbiosTool.Resources.imgui-frag.glsl");
